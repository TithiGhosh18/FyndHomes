...
<div id="page-wrapper">
    <div class="row"> 
        ...
        <!--	Banner Start   -->
        <div class="overlay-black w-100 slider-banner1 position-relative" id="mbackground" style="background-image: url('images/banner/rshmpg.jpg');  background-size: cover; background-position: center center; background-repeat: no-repeat; transition: background-image 1.3s ease;">
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We offer comprehensive solutions for property sales, leveraging expertise to maximize your returns.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>Unlock the perfect rental experience with our curated property listings and hassle-free leasing solutions.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We showcase a diverse range of properties, ensuring you find your ideal home or investment opportunity.</p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <p>We provide expert guidance on legally sound property investments, ensuring your financial security.</p>
                            </div>
                        </div>
                    </div>
                </div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>For top-rated services that exceed expectations, choose us as your trusted real estate partner</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Experience excellence rated at the top of the industry; choose us for unparalleled service and results</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>Our team of expert agents brings unparalleled industry knowledge and insight, ensuring your real estate journey is smooth and successful</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Engage in thorough discussions to outline your real estate aspirations and devise a strategic plan tailored to your goals. </p>
                    ...
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Meticulously review all pertinent documents and details to ensure a comprehensive understanding of the property and its potential</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <p>Efficiently navigate the acquisition process, leveraging our expertise to secure properties that align perfectly with your vision and requirements</p>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
        var backgroundImages = [
            ...
            'images/banner/unsplash1.jpg',
            'images/banner/unsplash2.jpg',
            'images/banner/unsplash5.jpg',
            'images/banner/unsplash3.jpg',
            'images/banner/rshmpg.jpg',
            'images/banner/unsplash6.jpg',
            'images/banner/unsplash7.jpg',
            'images/banner/unsplash8.jpg' // Add more image URLs as needed
        ];
        ...
        function changeBackground() {
            ...
            mbackground.classList.add('fade-out');
            // Set the next background image immediately after removing the animation class
            setTimeout(function() {
            currentIndex = (currentIndex + 1) % backgroundImages.length;
            var nextImage = backgroundImages[currentIndex];
            mbackground.style.backgroundImage = 'url(' + nextImage + ')';
        },400);


            // Remove the animation class after the animation completes
            setTimeout(function() {
                mbackground.classList.remove('fade-out');
            }, 800); // Adjust this value based on your animation duration

            
    }

        // Call the changeBackground function every 4 seconds
        setInterval(changeBackground, 3000); // 4000 milliseconds = 4 seconds
    </script>
</body>
